...
contract TeamVester is Ownable, ReentrancyGuard {
    ...
    function startVesting() external onlyOwner {
        ...
        require(IERC20(elk).balanceOf(address(this)) >= startingBalance, 'TeamVester::startVesting: incorrect ELK supply');
    ...
    function _claim() private returns (uint256) {
        require(block.timestamp >= lastUpdate + vestingCliff, 'TeamVester::claim: not time yet');
